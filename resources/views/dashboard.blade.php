...
<head>
  ...
  <title>Pharmatie en ligne</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{ asset('dashboard/template/vendors/ti-icons/css/themify-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('dashboard/template/vendors/base/vendor.bundle.base.css') }}">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{ asset('dashboard/template/css/style.css') }}">
  <!-- endinject -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="index.html"><img src="{{ asset('dashboard/template/images/logo.svg') }}" class="me-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('dashboard/template/images/logo-mini.svg') }}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ asset('dashboard/template/images/faces/face4.jpg') }}" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ asset('dashboard/template/images/faces/face2.jpg') }}" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="{{ asset('dashboard/template/images/faces/face3.jpg') }}" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              <img src="{{ asset('dashboard/template/images/faces/face28.jpg') }}" alt="profile"/>
            </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/ui-features/buttons.html') }}">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/ui-features/typography.html') }}">Typography</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ asset('dashboard/template/pages/forms/basic_elements.html') }}">
              <i class="ti-layout-list-post menu-icon"></i>
              <span class="menu-title">Form elements</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ asset('dashboard/template/pages/charts/chartjs.html') }}">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Charts</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ asset('dashboard/template/pages/tables/basic-table.html') }}">
              <i class="ti-view-list-alt menu-icon"></i>
              <span class="menu-title">Tables</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ asset('dashboard/template/pages/icons/themify.html') }}">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/samples/login.html') }}"> Login </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/samples/login-2.html') }}"> Login 2 </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/samples/register.html') }}"> Register </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/samples/register-2.html') }}"> Register 2 </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ asset('dashboard/template/pages/samples/lock-screen.html') }}"> Lockscreen </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ asset('dashboard/template/documentation/documentation.html') }}">
